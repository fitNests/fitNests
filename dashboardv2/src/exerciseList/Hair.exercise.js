...
const data = [
  "1. Start by placing your hands to the top of your head",
  "2. Bring your hands down as if you're straightening your hair",
];
                  ...
                  <div>
                    <Row gutter={[24, 24]}>
                      <Col span={16}>
                        <Title level={3}>
                          {" "}
                          Benefits : This exercise will train make you more
                          attractive than your peers
                        </Title>
                      ...
                      <Col span={8}>
                        <Row>
                          <Col span={15}>
                            ...
                            <center>
                              <DanceGif danceMove="hair" width="100%" />
                            </center>
                          </Col>
                          <Col span={9}>
                            <br />
                            ...
                            <br />
                            <center>
                              <Title level={4}>Sets : 7 {"\n"}</Title>
                              <Title level={4}>Reps : 2</Title>
                            </center>
                          </Col>
                        </Row>
