...
export default class DoughnutDisplay extends Component {
  ...
  componentDidMount() {
    ...
    if (this._isMounted) {
      ...
      //   this.timer = setInterval(() => this.setState(this.props), 500);
      //   this.timer = setInterval(() => console.log("Prop values", data), 500);
    }
  }
          ...
          datasets: [
            {
              ...
              data: [
                ...
                this.props.data[1],
                this.props.data[2],
                // this.props.userFeatures[0],
                // this.props.userFeatures[1],
                // this.props.userFeatures[2],
              ],
              backgroundColor: [
                "rgba(255, 99, 132, 0.6)",
                "rgba(54, 162, 235, 0.6)",
  ...
  render() {
    return (
      <div>
        <h1>Doughnut Display {this.props.data[1]}</h1>
        {/* <h1>User 1 features {this.props.userFeatures[1]}</h1> */}
