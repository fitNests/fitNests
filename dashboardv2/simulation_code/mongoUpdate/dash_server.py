...
livedata = db.livedatas
#records = db.livedatas
        ...
        while not self.shutdown.is_set():
            ...
            if data:
                try:
                    ...
                    records.delete_one({'type': 1})

                    livedata.delete_one({'id': 'stream'})
                    livedata.delete_one({'type': 1})

                    records.insert_one(decrypted_message)
                    livedata.insert_one(decrypted_message)
